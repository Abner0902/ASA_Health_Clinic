...
class RemindersMasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    var detailViewController: RemindersDetailViewController? = nil
    ...
    override func viewDidLoad() {
        ...
        if let split = splitViewController {
            ...
            detailViewController = (controllers[controllers.count-1] as! UINavigationController).topViewController as? RemindersDetailViewController
        }
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let object = fetchedResultsController.object(at: indexPath)
                let controller = (segue.destination as! UINavigationController).topViewController as! RemindersDetailViewController
